...
int exec_remote_cmd_loop(char *address, int port)
{
    ...
    // Allocate buffers for command input and response handling
    ...
    while (1) 
    {
        ...
        while (1) {
            ...
            // Ensure null termination and print response
            rsp_buff[io_size] = '\0';
            printf("%s", rsp_buff);

            // Check for EOF character to indicate end of transmission
